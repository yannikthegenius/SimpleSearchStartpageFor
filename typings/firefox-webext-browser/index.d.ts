...
declare namespace browser.cookies {
    ...
    interface Cookie {
        ...
        value: string;
        /** The domain of the cookie (e.g. "www.startpage.com", "example.com"). */
        domain: string;
        /**
...
declare namespace browser.privacy.websites {
     ...
     * third party account (such as a Facebook or Startpage login.) The value of this preference is of type boolean, and
...
declare namespace browser.tabs {
    ...
    function create(createProperties: {
         ...
         * 'http://www.startpage.com', not 'www.startpage.com'). Relative URLs will be relative to the current page within
